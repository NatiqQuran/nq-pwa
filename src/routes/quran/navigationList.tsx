...
function NavigationList() {
  ...
  return (
    <List direction="column">
      <ListItem>
        <Button size="medium" borderStyle="semi" onClick={handleClickQuran}>
          Quran
          <Spacer />
        </Button>
        <List
      ...
      <ListItem>
        <Button size="medium" borderStyle="semi" onClick={handleClickRsitation}>
          Rsitation
        </Button>
        <List
      ...
      <ListItem>
        <Button size="medium" borderStyle="semi" onClick={handleClickByWord}>
          By Word
        </Button>
        <List
      ...
      <ListItem>
        <Button size="medium" borderStyle="semi" onClick={handleClickTafsir}>
          Tafsir
        </Button>
        <List
