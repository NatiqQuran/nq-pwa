            ...
            <GridItem xl={12}>
              ...
              >
                ...
                >
                  ...
                  >
                    {surahFetch.responseBody.bismillah_status === "first_ayah"
                      ? `${
                          surahFetch.responseBody.ayahs[0].content.text
                        } ﴿${toArabic(
                          surahFetch.responseBody.ayahs[0].number
                        )}﴾`
                      : surahFetch.responseBody.bismillah_status === "true"
                ...
                <Stack>
                  ...
                  >
                    {surahFetch.responseBody.bismillah_status === "first_ayah"
                      ...
                      : surahFetch.responseBody.ayahs.map((ayah) => (
                          <Ayah ayah={ayah} />
                        ))}
                  </span>
                </Stack>
